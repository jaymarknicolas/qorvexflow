...
export default function Header({ onLayoutClick }: HeaderProps = {}) {
  ...
  const getThemeColors = () => {
    ...
    if (theme === "horizon") {
      if (isLight) {
        return {
          logoGradient: "from-orange-500 via-sky-500 to-violet-500",
          logoShadow: "shadow-sky-500/25 group-hover:shadow-sky-500/40",
          logoGlow: "from-orange-500 to-violet-500",
          textGradient: "from-orange-600 via-sky-600 to-violet-600",
      ...
      return {
        logoGradient: "from-orange-400 via-sky-400 to-violet-400",
        logoShadow: "shadow-sky-500/25 group-hover:shadow-sky-500/40",
        logoGlow: "from-orange-400 to-violet-400",
        textGradient: "from-orange-400 via-sky-400 to-violet-400",
